    ...
    return (
        <div>
            <div className="gridHeader">
                <img src={props.profileImage} className="profilePictures" alt="The Profile Pictures"/>
        ...
        return (
            <article>
                <div className="contentGrid">
                    <GridContent   
                        profileImage={require("./Images/parents_profile_picture.png")}
                    ...
                    />
                    <GridContent 
                        profileImage={require("./Images/nannies_profile_picture.png")}
                ...
                <div className="flexLocalFamilies">
                    ...
                    <p className="text">
                        Families in your area need childcare. There simply is not enough to go around. They need it locally and 
                        at a rate they can afford. In short, they need you. And you need to reduce costs or if a nanny, increase 
                        your pay. It’s a win, win, win! But first families need to find you. Go on, reach out to your neighbourhood 
                        today with a Hapu nanny share.
                    </p>
                    <a href="https://www.jungle.rocks/" className="purpleLink">Create your nanny share today</a>
                    <img 
                        src={require("./Images/local_families_image.png")} 
                        alt="Map including people nearby"
                        className="localFamiliesPicture"    
                    />
                    <img 
                        src={require("./Images/local_families_image_mobile.png")} 
                        alt="Map including people nearby"
